...
RUN LONG OPS TO COMPLETION INLINE — do NOT background-and-rest. A build, test run, install, or CI watch must be polled INLINE (its output file / \`ps\` / the result) until it FINISHES; then return your deliverable. Do NOT rest on a waiter/monitor.
